...
export default function ClientTestimonialPoster() {
  return (
    <div className="flex items-center justify-center">
      ...
      <div className="ClientTestimonialPoster relative w-full max-w-md rounded-3xl shadow-2xl overflow-hidden bg-[#efeff7]" style={{
        ...
        {/* Decorative circles */}
        <div className="absolute top-20 left-8 w-13 h-13 rounded-full" style={{ backgroundColor: 'var(--primary)' }}></div>
        <div className="absolute top-14 right-8 w-14 h-14 rounded-full" style={{ backgroundColor: 'var(--secondary)' }}></div>
        <div className="absolute bottom-6 right-0 w-12 h-12 rounded-full" style={{ backgroundColor: 'var(--primary)' }}></div>
        ...
        <div className="relative z-10 h-full flex flex-col p-8">
          ...
          <div className="flex-1 flex items-center justify-center mb-6 relative">
            ...
            <div className="absolute -bottom-30 z-0 left-1/2 -translate-x-1/2 w-100 h-100 rounded-full" style={{ backgroundColor: 'var(--secondary)' }}></div>
          ...
          <div className="rounded-2xl absolute left-22 bottom-14 z-20 px-4 py-2 max-w-[270px] border-4 border-white/60 mb-6" style={{ backgroundColor: 'var(--primary)' }}>
            <p className="text-white text-xs font-bold leading-relaxed text-center mb-3">
              "Working with [company name] gave us clarity and direction. Our customers finally understand what we stand for."
            </p>
