            ...
            <div className="example-poster relative w-full max-w-md rounded-3xl shadow-2xl overflow-hidden" style={{
                ...
                <div className="relative z-10 h-full flex flex-col p-8">
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-semibold leading-tight tracking-tight" style={{ color: 'var(--secondary)' }}>
                    ...
                    {/* Image section */}
                    <div className="mb-3">
                        <div className="rounded-lg overflow-hidden shadow-lg bg-white" style={{ height: '240px' }}>
                            <img
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center gap-3">
                        <div className="flex gap-3 w-full justify-center">
                            <div className="px-3 py-1 rounded-xl shadow-lg text-center" style={{ backgroundColor: 'var(--secondary)' }}>
