  ...
  const formatOptions = [
    {
      ...
      icon: (
        <Image
          className="w-12 h-12 text-purple-600 relative z-10 group-hover:text-purple-700 transition-colors"
          strokeWidth={1.5}
        />
      ),
      bg: "bg-linear-to-br from-purple-100 to-indigo-100",
      ...
      decorative: (
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            <div
              className="absolute w-16 h-16 border-2 border-indigo-300 rounded-full opacity-30 group-hover:animate-ping"
              style={{ animationDelay: "0.3s" }}
            ></div>
            <div
              className="absolute w-12 h-12 border-2 border-purple-400 rounded-full opacity-40 group-hover:animate-ping"
    ...
    },
    {
      ...
      icon: (
        <Layout
          className="w-12 h-12 text-green-600 relative z-10 group-hover:text-green-700 transition-colors"
          strokeWidth={1.5}
        />
      ),
      bg: "bg-linear-to-br from-green-100 to-emerald-100",
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <svg className="absolute inset-0 w-full h-full">
            ...
            <rect
              ...
              width="4"
              height="4"
              className="fill-emerald-300 opacity-25 group-hover:animate-pulse group-hover:scale-110 transition-transform"
            />
          </svg>
        </div>
      ),
    },
    {
      ...
      bg: "bg-linear-to-br from-blue-100 to-cyan-100",
      ...
      decorative: (
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div
            className="absolute bottom-3 left-3 w-6 h-6 border-2 border-cyan-300 rounded-full opacity-60 group-hover:animate-ping"
            style={{ animationDelay: "0.3s" }}
          ></div>
          <svg className="absolute inset-0 w-full h-full">
            <circle
    ...
    },
    {
      ...
      bg: "bg-linear-to-br from-orange-100 to-yellow-100",
      ...
      decorative: (
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-3 left-1/2 transform -translate-x-1/2 flex space-x-1">
            <div
              className="w-2 h-2 bg-orange-400 rounded-full group-hover:bg-orange-500 transition-colors group-hover:animate-bounce"
              style={{ animationDelay: "0s" }}
            ></div>
            <div
              className="w-2 h-2 bg-yellow-400 rounded-full group-hover:bg-yellow-500 transition-colors group-hover:animate-bounce"
    ...
    <div className="px-14">
      ...
      <div className="flex flex-col items-center justify-center text-center py-5">
        ...
        <p className="text-gray-500 text-md mb-4">
          No socials have been created yet. <br /> Click the create button to
