                    ...
                    <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            ...
                            <pattern id="tile-pattern" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
                                <rect x="0" y="0" width="50" height="50" fill="var(--accent-on-secondary)" />
                                <rect x="50" y="50" width="50" height="50" fill="var(--accent-on-secondary)" />
                            </pattern>
                            ...
                            <mask id="fade-mask">
                                <rect width="100%" height="100%" fill="var(--accent-on-secondary)" />
                                <rect
                                    width="100%"
                                    height="100%"
                                    fill="black"
                    ...
                    <div className="flex-1 flex flex-col items-center">
                        ...
                        <div className="relative  mb-6">
                            ...
                            <div className="z-50 relative -right-52 bottom-10">
                                <h3 className="text-base font-bold text-[var(--primary)]">Felix Sap</h3>
                                <p className="text-xs text-[var(--primary)]">Co-founder</p>
                            </div>

                            {/* Conversion rate boost card - bottom overlapping */}
                            <div className="absolute -bottom-35 left-45 -translate-x-1/2 bg-[image:var(--gradient-primary)] rounded-xl p-6 shadow-2xl">
