        ...
        <div className="relative z-10 py-8">
          ...
          <div className="flex items-center justify-between px-8 mb-8">
            <div className="flex items-center gap-2">
              <Zap className="w-8 h-8" style={{ color: 'var(--secondary)' }} fill="currentColor" />
              <div>
            ...
            <button className="px-4 py-2 rounded-full border border-white text-sm font-semibold shadow-lg transition-all flex items-center gap-2 bg-transparent text-white hover:bg-white hover:text-blue-700">
              LET'S CONNECT
              <span className="w-5 h-5 rounded-full rotate-45 flex items-center justify-center text-xs" style={{ backgroundColor: 'var(--secondary)', color: 'var(--text-on-secondary)' }}>↑</span>
            </button>
          </div>
          ...
          <div className="mb-6 px-8">
            <h1 className="font-bold text-4xl leading-tight text-white mb-4">
              Understanding<br />
              Quick Tips Monitor<br />
              Market Value
            </h1>

            <p className="text-sm leading-relaxed font-normal opacity-90 text-white max-w-sm">
              Webinars give you exclusive access to experts who share proven methods, real experiences
            </p>
          </div>
          ...
          <div className="relative mb-6 px-8">
            <div className="relative h-72">
              ...
              <div className="absolute bottom-0 right-0 w-3/5 h-full">
                <svg viewBox="0 0 300 400" className="w-full h-full absolute" style={{ overflow: 'visible' }}>
                  <path 
              ...
              <div className="relative flex gap-4 h-full">
                {/* List Box */}
                <div className="w-1/2 flex flex-col justify-center gap-3 z-20" style={{ 
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: 'var(--secondary)' }}>
                      <svg className="w-4 h-4" style={{ color: 'var(--text-on-secondary)' }} fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"/>
                      </svg>
                    </div>
                    <span className="text-white text-sm font-semibold">Provide Brand SDK</span>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-white text-sm font-semibold">Market High/lows</span>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-white text-sm font-semibold">Cognitive Resonance</span>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-white text-sm font-semibold">Haptic Branding</span>
                  </div>
                </div>
