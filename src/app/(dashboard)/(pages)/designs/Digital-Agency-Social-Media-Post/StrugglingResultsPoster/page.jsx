            ...
            <div className="struggling-poster relative w-full max-w-md rounded-3xl shadow-2xl overflow-hidden" style={{
                ...
                <div className="relative z-10 h-full flex flex-col p-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <div className="inline-block rotate-[-5deg] px-6 py-1 rounded-full mb-2" style={{ backgroundColor: 'var(--secondary)' }}>
                            <h1 className="text-3xl font-bold leading-tight" style={{ color: 'var(--text-on-secondary)' }}>
                                Get Results
                            </h1>
                        </div>
