  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-8">
      <div
        ...
        style={{
          backgroundColor: "var(--linear-primary)",
      ...
      >
        ...
        <div className="absolute top-0 right-0 bottom-0 w-[90%] bg-[image:var(--linear-primary)]">
          ...
          <div className="w-[60%] flex pl-18 flex-col justify-between p-6">
            ...
            <div className=" flex flex-col justify-center">
              ...
              <p className="text-sm text-[var(--secondary)] w-[150px] opacity-90">
                The most seamless agency experience we've had — they understand
