            ...
            >
                ...
                <div className="relative z-10 h-full flex flex-col p-8">
                    ...
                    <div className="flex-1 relative">
                        ...
                        <div className="absolute -top-41 right-0 bg-[image:var(--gradient-primary)] rounded-xl p-5 shadow-2xl w-46">
                            {/* 3x with triangle icon */}
                            <div className="flex items-center gap-3 mb-4">
                                <h2 className="text-5xl font-bold text-[var(--secondary)]">3×</h2>
                                <div className="w-12 h-12 flex items-center justify-center">
                                    <svg viewBox="0 0 100 100" className="w-full h-full">
                                        <polygon points="50,10 90,80 10,80" fill="white" opacity="0.3" />
                                    </svg>
                                </div>
                            </div>
                            ...
                            <p className="text-sm font-medium pb-14 text-[var(--secondary)] ">
                                They helped us build a new content system that increased organic traffic by 3×
                            </p>
                        </div>
                    </div>
