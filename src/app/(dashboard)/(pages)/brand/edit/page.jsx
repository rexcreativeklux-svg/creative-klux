  ...
  return (
    <div className="flex flex-col gap-1.5 flex-1">
      ...
      <div className="flex items-center gap-2">
        <label
          className="w-9 h-9 rounded-xl border border-gray-200 cursor-pointer overflow-hidden shadow-sm shrink-0"
        ...
        <input
          ...
          className={`${inputCls} font-mono text-xs w-28 shrink-0`}
        />
      </div>
    </div>
  );
