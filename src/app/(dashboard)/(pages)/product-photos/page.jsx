...
const studioColors = [
    '#f5f0e0', '#ede8d8', '#e0dbd0', '#f0ede0',
    '#f5e8e0', '#e8f0e0', '#e0eef5', '#f5e0ed',
];
...
function ProductIcon({ className = '' }) {
    return (
        <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
            <path d="M8 30 Q10 22 20 20 Q30 18 32 30" stroke="#9ca3af" strokeWidth="1.5" fill="none" />
...
export default function ProductPhotos() {
    ...
    const filteredGetStarted = q ? getStarted.filter(g => g.label.toLowerCase().includes(q)) : getStarted;
                    ...
                    <>
                        ...
                        <div className="flex gap-3 mb-8">
                            {filteredClassics.map((c, i) => (
                                ...
                                >
                                    <div
                                        className={`w-20 h-20 rounded-xl border-2 transition-all hover:border-blue-400 flex items-center justify-center overflow-hidden ${c.active ? 'border-blue-500' : 'border-gray-200'
                                            } ${c.bg}`}
                                    >
