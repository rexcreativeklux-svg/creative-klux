...
const ModernAdsPostPage = () => {
  ...
  const campaignGoalOptions = [
    ...
    },
    {
      ...
      label: "Engagement",
      subtitle: "AI Smart Optimization",
      description: "Encourage likes, comments, and shares on your content.",
    },
    {
      value: "Sales",
      label: "Sales",
  ...
  const audienceOptions = [
    {
      ...
      description: "Business owners, startups, agencies",
    },
    {
      value: "B2C",
      label: "B2C (Customer-Friendly)",
      description: "End consumers, everyday users",
    },
    {
      value: "Casual",
      label: "Casual / Social-first",
      description: "Broad social media audience",
    },
    {
      value: "Inspirational",
      label: "Inspirational / Motivational",
      description: "Entrepreneurs, creators, startups",
    },
    {
      value: "Sales",
      label: "Direct / Sales-oriented",
      description: "Hot leads, ad audiences",
    },
  ];
      ...
      <div className="pt-3">
        <div className="flex space-x-2 px-2">
          ...
          <div className="flex-1">
            <div className="flex flex-col space-x-1">
              <h3 className="font-semibold text-gray-900 text-[12px]">
                Your Name
              </h3>
        ...
        <div className="py-2 px-2">
          <p className="text-[10px]">
            Step into the future with Weviy! ✨ From sleek gadgets to
            lifestyle-enhancing digital solutions...
          </p>
        </div>
          ...
          <div className="mb-2 bg-gray-100 h-48 flex items-center justify-center">
            <div className="text-center px-10">
              <div className="text-gray-500 mb-1 text-sm">
                Click to upload images and Videos and see the preview here!
              </div>
            </div>
          </div>
        )}
    ...
    <div className="min-h-screen px-16 pt-5">
      <div className="">
        ...
        <div className="flex flex-row gap-8 py-3 ">
          ...
          <div
            ref={leftColumnRef}
            className="w-[50%] space-y-10 pl-1 pr-5 overflow-y-auto max-h-[80vh]"
          >
            {/* URL Section */}
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {campaignGoalOptions.map((goal) => (
                  <div
                    ...
                    className={`px-3 py-3 relative rounded-lg cursor-pointer transition-colors ${
            ...
            <div className="bg-surface rounded-xl">
                ...
                <div className="flex flex-col pt-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) =>
                        setStartDate(e.target.value.replace("T", " "))
                      }
                ...
                <div>
                  <div className="flex flex-row justify-between mb-3">
                    ...
                    <div className="flex space-x-2">
                      <button className="px-2 py-1 bg-gray-100 text-gray-600 rounded-lg text-sm hover:bg-gray-200 transition-colors">
                        3D
                      </button>
                      <button className="px-2 py-1 bg-gray-100 text-gray-600 rounded-lg text-sm hover:bg-gray-200 transition-colors">
                        14D
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={(e) =>
                        setEndDate(e.target.value.replace("T", " "))
                      }
                      className="w-full cursor-pointer px-2 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                  </div>
              ...
              <p className="text-xs text-center text-gray-500 mt-3">
                ...
                at least 3 days for optimal results.
              </p>
            </div>
          ...
          <div className="w-[50%] flex rounded-xl border border-gray-200 flex-col space-y-6 overflow-y-auto max-h-[80vh]">
            ...
            <div className="bg-surface py-6 px-5">
              ...
              <div className="flex justify-center space-x-3 bg-gray-100 p-2 rounded-lg">
                <div className="w-5 h-5 bg-gray-300 rounded-full flex items-center justify-center shrink-0">
            ...
            <div className="bg-surface p-3 flex-1">
              ...
              <div className="flex flex-row pb-3 gap-4">
                <div className="w-[50%] space-y-4">
                    ...
                    {isAdContentOpen && (
                      <div className="mt-2 py-4 border-b border-b-gray-200">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">
                            Step into the future with Weviy! ✨ From sleek
                            gadgets to lifestyle-enhancing digital solutions...
                          </p>
                        </div>
                      </div>
                    )}
                  ...
                  <div className="">
                    <span className="font-medium text-gray-700 pb-4 block">
                      Audience Targeting
                    </span>
                    <div className="grid grid-cols-2 gap-2">
                      {audienceOptions.map((audience, index) => (
                        <div
                          ...
                          className={`flex items-center px-2 py-1 rounded-lg text-xs cursor-pointer transition-colors ${
              ...
              <button
                ...
                className="w-full cursor-pointer bg-blue-700 hover:bg-blue-800 text-white py-3 rounded-lg font-medium transition-colors"
              >
                Publish Ads
              </button>
            </div>
