          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="relative gap-4">
              <div className="flex bg-white rounded-lg shadow-lg relative">
                <p
                  className="text-md py-3 px-5 pr-10 font-bold"
                ...
                <span
                  className="text-[110px] absolute -right-1 rotate-5 -top-13 font-bold"
                  style={{ color: "var(--secondary)" }}
                >
                  1
                </span>
            ...
            <div className="relative gap-4">
              <div className=" bg-white rounded-lg shadow-lg">
                <span
                  className="text-[100px] absolute -left-2 rotate-5 -top-10 font-bold"
                  style={{ color: "var(--secondary)" }}
                >
                  2
                </span>
                <p
                  className="text-md py-3 px-5 pl-15 font-bold"
                  style={{ color: "var(--primary)" }}
                >
            ...
            <div className="relative gap-4">
              <div className="flex bg-white rounded-lg shadow-lg relative">
                <p
                  className="text-md py-3 px-5 pr-13 font-bold"
                  style={{ color: "var(--primary)" }}
                >
                ...
                <span
                  className="text-[100px] absolute -right-1 rotate-8 -top-10 font-bold"
                  style={{ color: "var(--secondary)" }}
                >
                  3
                </span>
