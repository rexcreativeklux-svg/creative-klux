...
export default function SilentFactorsPoster() {
  return (
    <div className=" flex items-center justify-center p-8">
      ...
      <div
        className="yellow-poster relative w-full max-w-md rounded-md shadow-2xl overflow-hidden"
        style={{
        ...
        <div className="relative z-10 p-8 h-full flex flex-col justify-between">
          ...
          <div className="pt-4 relative">
            <div className="flex items-start gap-4 mb-4">
              <h1
                className="font-medium absolute top-8 text-3xl w-[200px] leading-[1.3] tracking-tight"
                style={{ color: "var(--text-on-primary)", maxWidth: "70%" }}
              >
                There Are Silent Factors That Change Market Value
              </h1>
              <div className="shrink-0 absolute top-6 left-36 w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-lg mt-1">
                <div
                  className="font-bold -mt-0.5 w-4 border-b-2 "
          ...
          <div className="relative px-8 mt-auto">
            <div
              className="absolute -top-25 right-0 text-[0.65rem] max-w-[160px] leading-tight font-medium"
              style={{ color: "var(--text-on-primary)" }}
            >
              Uncover hidden factors that investors often overlook when
