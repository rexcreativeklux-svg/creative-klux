...
import { Image, Download, CheckCircle2, FileSearch, FolderOpen, FileUp, MoreVertical, Send, Calendar } from 'lucide-react';
...
const ThumbnailsCreativeWizard = () => {
  ...
  const [searchResults, setSearchResults] = useState([
    { id: 1, src: 'https://images.pexels.com/photos/3184297/pexels-photo-3184297.jpeg', alt: 'Thumbnail 1', type: 'image' },
    { id: 2, src: 'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg', alt: 'Thumbnail 2', type: 'image' },
    { id: 3, src: 'https://images.pexels.com/photos/3184325/pexels-photo-3184325.jpeg', alt: 'Thumbnail 3', type: 'image' },
  ]);
  ...
  const inspirePrompts = useMemo(() => [
    'A vibrant thumbnail for a YouTube video',
    'A bold thumbnail for an Instagram post',
    'A trendy thumbnail for a social media campaign',
    'A professional thumbnail for a product launch',
  ], []);
  ...
  const handleFileChange = useCallback((e) => {
    ...
    files.forEach((file) => {
      ...
      reader.onload = () => {
        ...
        const newAsset = { id: Date.now() + processed, src: url, alt: `Uploaded image ${processed + 1}`, type: 'image' };
        newAssets.push(newAsset);
        processed++;
        if (processed === files.length) {
          setSearchResults((prev) => [...newAssets, ...prev]);
  ...
  const handleInspire = useCallback(() => {
    ...
    setTimeout(() => {
      ...
      const mockSuggestions = {
        caption: `Eye-catching thumbnail for ${postData.brandName}! ${postData.description.slice(0, 50)}... #${keywords[0] || 'Thumbnail'}`,
        hashtags: [
  ...
  const saveCroppedImage = useCallback(() => {
    ...
    canvas.toBlob((blob) => {
      const file = new File([blob], `cropped-thumbnail-${currentCropIndex + 1}.png`, { type: 'image/png' });
      const url = URL.createObjectURL(file);
      const croppedAsset = { id: `cropped-${Date.now()}`, src: url, alt: `Cropped thumbnail ${currentCropIndex + 1}`, type: 'image' };
  ...
  const handleSkipCrop = useCallback(async () => {
    ...
    try {
      ...
      const file = new File([blob], `original-thumbnail-${currentCropIndex + 1}.png`, { type: blob.type });
      const url = URL.createObjectURL(file);
      const originalAsset = { id: `original-${Date.now()}`, src: url, alt: `Original thumbnail ${currentCropIndex + 1}`, type: 'image' };
  ...
  return (
    <div className="px-14">
      <div className="font-medium text-xl">Create Social Media Thumbnails</div>

      {result ? (
        <div className="flex flex-col overflow-hidden w-full mt-3 justify-between gap-6 bg-white rounded-lg py-4">
          <div className="font-medium pb-4">Generated Thumbnails</div>
                  ...
                  <div className="space-y-5 border rounded-md border-gray-200 p-3">
                    <div className="flex border border-gray-200 rounded-md py-2 px-2 gap-2">
                      ...
                      <div className="flex flex-col justify-center">
                        ...
                        <p className="text-gray-600 text-xs"> Enter details for your thumbnail.</p>
                      </div>
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        placeholder="Enter a description for your thumbnails (e.g., 'Vibrant thumbnails for a YouTube video')"
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 relative">
                        ...
                        <div className="flex relative items-center gap-2">
                          <input
                            type="text"
                            placeholder="Hashtags (e.g., #Thumbnail #Brand)"
                  ...
                  <div className="text-sm flex justify-between border-b p-2 border-b-gray-200 flex-row mb-6">
                    <div className="flex justify-center gap-2">
                      ...
                      <div className="flex flex-col justify-center">
                        ...
                        <p className="text-gray-600 text-xs">Select size, campaign goals, and audience for your thumbnails.</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="border border-gray-200 p-3 rounded-lg">
                  <div className="text-sm flex justify-between border-b p-2 border-b-gray-200 flex-row mb-6">
                    <div className="flex justify-center gap-2">
                      ...
                      <div className="flex flex-col justify-center">
                        ...
                        <p className="text-gray-600 text-xs">Select images for your thumbnails.</p>
                      </div>
                    </div>
                  </div>
                  <div className="space-y-6">
                    ...
                    <div className="flex mb-10 flex-col space-y-4 border border-gray-200 py-5 bg-gray-50 justify-center items-center">
                      ...
                      <p className="text-gray-500 text-xs">Choose images from your brand, library, or generate one with magic media.</p>
                      <div className="flex gap-4">
                        <button
...
export default ThumbnailsCreativeWizard;