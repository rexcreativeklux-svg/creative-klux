  ...
  const formatOptions = [
    {
      ...
      bg: "bg-linear-to-br from-blue-100 to-sky-100",
      ...
      decorative: (
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            <div
              className="absolute w-16 h-16 border-2 border-sky-300 rounded-full opacity-30 group-hover:animate-ping"
              style={{ animationDelay: "0.3s" }}
            ></div>
            <div
              className="absolute w-12 h-12 border-2 border-blue-400 rounded-full opacity-40 group-hover:animate-ping"
          ...
          <svg className="absolute inset-0 w-full h-full">
            <circle
              ...
              cy="30%"
              r="4"
              className="fill-blue-300 opacity-20 group-hover:animate-pulse group-hover:scale-110 transition-transform"
            />
            <circle
              cx="70%"
              cy="50%"
              r="6"
              className="fill-sky-300 opacity-25 group-hover:animate-pulse group-hover:scale-110 transition-transform"
            />
            <rect
              x="60%"
              y="20%"
      ...
      icon: (
        <div className="relative flex items-center justify-center">
          ...
          <svg
            ...
            stroke="currentColor"
            strokeWidth="1.5"
            className="w-12 h-12 text-violet-600 relative z-10 group-hover:text-violet-700 transition-colors"
          >
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <svg className="absolute inset-0 w-full h-full">
            <circle
              ...
              cy="40%"
              r="5"
              className="fill-violet-300 opacity-25 group-hover:animate-pulse group-hover:scale-110 transition-transform"
            />
            <rect
              x="50%"
              y="60%"
              width="4"
              height="4"
              className="fill-purple-300 opacity-20 group-hover:animate-pulse group-hover:scale-110 transition-transform"
            />
          </svg>
        </div>
      ),
    },
    {
      ...
      icon: (
        <div className="relative flex items-center justify-center">
          ...
          <svg
            ...
            stroke="currentColor"
            strokeWidth="1.5"
            className="w-12 h-12 text-emerald-600 relative z-10 group-hover:text-emerald-700 transition-colors"
          >
      ...
      bg: "bg-linear-to-br from-emerald-100 to-green-100",
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <svg className="absolute inset-0 w-full h-full">
            <circle
              ...
              cy="20%"
              r="3"
              className="fill-emerald-300 opacity-20 group-hover:animate-pulse group-hover:scale-110 transition-transform"
            />
            <rect
              x="70%"
              y="50%"
              width="4"
              height="4"
              className="fill-green-300 opacity-25 group-hover:animate-pulse group-hover:scale-110 transition-transform"
            />
          </svg>
        </div>
      ),
      ...
      icon: (
        <div className="relative flex items-center justify-center">
          ...
          <svg
            ...
            stroke="currentColor"
            strokeWidth="1.5"
            className="w-12 h-12 text-orange-600 relative z-10 group-hover:text-orange-700 transition-colors"
          >
      ...
      decorative: (
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 flex space-x-2">
            <div
              className="w-3 h-3 bg-orange-400 rounded-full group-hover:bg-orange-500 group-hover:animate-bounce transition-colors"
              style={{ animationDelay: "0s" }}
            ></div>
            <div
              className="w-3 h-3 bg-amber-400 rounded-full group-hover:bg-amber-500 group-hover:animate-bounce transition-colors"
          ...
          <svg className="absolute inset-0 w-full h-full">
            ...
            <rect
              ...
              width="3"
              height="3"
              className="fill-amber-300 opacity-20 group-hover:animate-pulse group-hover:scale-110 transition-transform"
            />
          </svg>
        </div>
      ),
    },
    {
      ...
      icon: (
        <div className="relative flex items-center justify-center">
          ...
          <svg
            ...
            stroke="currentColor"
            strokeWidth="1.5"
            className="w-12 h-12 text-pink-600 relative z-10 group-hover:text-pink-700 transition-colors"
          >
      ...
      bg: "bg-linear-to-br from-pink-100 to-rose-100",
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <svg className="absolute inset-0 w-full h-full">
            <circle
              ...
              cy="40%"
              r="4"
              className="fill-pink-300 opacity-25 group-hover:animate-pulse group-hover:scale-110 transition-transform"
            />
            <rect
              x="30%"
              y="50%"
    ...
    },
    {
      ...
      icon: (
        <div className="relative flex items-center justify-center">
          ...
          <svg
            ...
            stroke="currentColor"
            strokeWidth="1.5"
            className="w-12 h-12 text-teal-600 relative z-10 group-hover:text-teal-700 transition-colors"
          >
      ...
      bg: "bg-linear-to-br from-teal-100 to-cyan-100",
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <svg className="absolute inset-0 w-full h-full">
            <circle
              ...
              cy="50%"
              r="5"
              className="fill-teal-300 opacity-25 group-hover:animate-pulse group-hover:scale-110 transition-transform"
            />
            <rect
              x="60%"
              y="30%"
              width="3"
              height="3"
              className="fill-cyan-300 opacity-20 group-hover:animate-pulse group-hover:scale-110 transition-transform"
            />
          </svg>
        </div>
      ),
    },
    {
      ...
      bg: "bg-linear-to-br from-lime-100 to-yellow-100",
      hoverBg: "group-hover:from-lime-200 group-hover:to-yellow-200",
      decorative: (
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute bottom-4 left-6 right-6 flex space-x-1">
            <div
              className="w-2 h-4 bg-lime-400 rounded group-hover:bg-lime-500 group-hover:animate-pulse transition-colors"
              style={{ animationDelay: "0s" }}
            ></div>
            <div
              className="w-2 h-6 bg-yellow-400 rounded group-hover:bg-yellow-500 group-hover:animate-pulse transition-colors"
              style={{ animationDelay: "0.2s" }}
            ></div>
            <div
              className="w-2 h-5 bg-lime-400 rounded group-hover:bg-lime-500 group-hover:animate-pulse transition-colors"
              style={{ animationDelay: "0.4s" }}
            ></div>
          </div>
          <svg className="absolute inset-0 w-full h-full">
    ...
    },
    {
      ...
      icon: (
        <div className="relative flex items-center justify-center">
          ...
          <svg
            ...
            stroke="currentColor"
            strokeWidth="1.5"
            className="w-12 h-12 text-indigo-600 relative z-10 group-hover:text-indigo-700 transition-colors"
          >
      ...
      bg: "bg-linear-to-br from-indigo-100 to-blue-100",
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <svg className="absolute inset-0 w-full h-full">
            <circle
              ...
              cy="30%"
              r="5"
              className="fill-indigo-300 opacity-25 group-hover:animate-pulse group-hover:scale-110 transition-transform"
            />
            <rect
              x="20%"
              y="60%"
    ...
    },
    {
      ...
      icon: (
        <div className="relative flex items-center justify-center">
          ...
          <svg
            ...
            stroke="currentColor"
            strokeWidth="1.5"
            className="w-12 h-12 text-gray-600 relative z-10 group-hover:text-gray-700 transition-colors"
          >
      ...
      bg: "bg-linear-to-br from-gray-100 to-slate-100",
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <svg className="absolute inset-0 w-full h-full">
            <circle
              ...
              cy="50%"
              r="4"
              className="fill-gray-300 opacity-25 group-hover:animate-pulse group-hover:scale-110 transition-transform"
            />
            <rect
              x="60%"
              y="40%"
              width="4"
              height="4"
              className="fill-slate-300 opacity-20 group-hover:animate-pulse group-hover:scale-110 transition-transform"
            />
          </svg>
        </div>
      ),
    },
    {
      ...
      icon: (
        <div className="relative flex items-center justify-center">
          ...
          <svg
            ...
            stroke="currentColor"
            strokeWidth="1.5"
            className="w-12 h-12 text-sky-600 relative z-10 group-hover:text-sky-700 transition-colors"
          >
            <rect x="2" y="6" width="20" height="12" rx="2" />
      ...
      bg: "bg-linear-to-br from-sky-100 to-blue-100",
      ...
      decorative: (
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 flex space-x-2">
            <div
              className="w-3 h-3 bg-sky-400 rounded-full group-hover:bg-sky-500 group-hover:animate-bounce transition-colors"
              style={{ animationDelay: "0s" }}
            ></div>
            <div
              className="w-3 h-3 bg-blue-400 rounded-full group-hover:bg-blue-500 group-hover:animate-bounce transition-colors"
              style={{ animationDelay: "0.2s" }}
            ></div>
            <div
              className="w-3 h-3 bg-sky-400 rounded-full group-hover:bg-sky-500 group-hover:animate-bounce transition-colors"
    ...
    <div className="px-14">
      ...
      <div className="flex flex-col items-center justify-center text-center py-5">
        ...
        <p className="text-gray-500 text-md mb-4">
          No designer creative have been created yet. <br /> Click the create
          button to kickstart your campaign!
        </p>
      ...
      <div className="grid grid-cols-4 gap-4 pb-20 mt-8">
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 bg-opacity-50 overflow-auto">
            <div className="relative flex flex-col w-11/12 max-w-5xl max-h-[90vh] bg-linear-to-b from-gray-50 to-gray-100 p-6 rounded-lg shadow-lg animate-in duration-300 ease-out data-[state=open]:fade-in-0 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 modal">
              <button
                onClick={() => {
                  setIsModalOpen(false);
                  setIsLoading(false);
