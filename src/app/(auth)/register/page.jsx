      ...
      <div className="flex-1 flex flex-col items-center ">
        <div className=" md:pt-10 lg:pt-20 pb-5 flex flex-col gap-4 md:gap-5 lg:gap-10 ">
          <div className="flex flex-col space-y-5 justify-center items-center">
            <div
              className={`flex items-center pb-10 shrink-0 border-b border-gray-100 cursor-pointer
          `}
            >
              <img
                src="/logoblue.svg"
            ...
            >
              ...
              <div className="mb-6">
                ...
                <p className="text-[#155dfc] text-xs p-1 px-5 mt-1">
                  Leave (License Code) empty if it's a free trial account.(7
                  days)
                </p>
              </div>
              ...
              <div className="relative">
                ...
                {passwordLengthError && (
                  <p className="text-red-600 px-4 text-xs mt-1">
                    {passwordLengthError}
                  </p>
                )}
              </div>
              ...
              {error && (
                <p className="text-red-500 text-xs px-4 mt-2">{error}</p>
              )}
                  ...
                  <div className="bg-surface rounded-lg p-6 flex flex-col max-w-md items-center shadow border border-gray-200 animate-fadeIn">
                    <div
                      className={`w-16 h-16 flex items-center justify-center rounded-full mb-4 ${
                        modalType === "success" ? "bg-green-50" : "bg-red-50"
                      }`}
                    >
                      {modalType === "success" ? (
                        <svg
