    ...
    return (
        <div className=" flex items-center justify-center">
            ...
            <div className="ClientTestimonialPoster relative w-full max-w-md rounded-3xl shadow-2xl overflow-hidden" style={{
                ...
                <div className="absolute -bottom-12 -left-50 w-120 h-120 z-10 rounded-full" style={{ backgroundColor: 'var(--primary)' }}></div>
                ...
                <div className="relative z-10 h-full flex flex-col p-8">
                    ...
                    <div className=" flex relative gap-6">
                        ...
                        <div className=" flex flex-col justify-between">
                            {/* Headlines */}
                            <div>
                                <h1 className="text-3xl z-20 font-black leading-tight mb-3" style={{ color: 'var(--primary)' }}>
                                    Your Market<br />
                                    Value
                                </h1>
                                ...
                                <div className="mb-3">
                                    <svg width="20" height="30" viewBox="0 0 40 30">
                                        <line x1="0" y1="8" x2="40" y2="8" stroke="var(--secondary)" strokeWidth="8" />
                                        <line x1="0" y1="22" x2="40" y2="22" stroke="var(--secondary)" strokeWidth="8" />
                                    </svg>
                                </div>

                                <h2 className="text-3xl z-20 font-black leading-tight mb-6" style={{ color: 'var(--secondary)' }}>
                                    Your<br />
                                    Compass
                                </h2>
                                ...
                                <p className="text-xs text-[var(--text-on-primary)] max-w-[220px] text-left font-medium z-20 leading-relaxed mb-6">
                                    It guides every decision, keeps your brand aligned, and shows customers what you stand for.
                                </p>
                            </div>
                        ...
                        <div className="flex-shrink-0 absolute top-10 -right-2 flex justify-center" style={{ width: '45%' }}>
                            <div className="absolute top-0 left-8 w-40 h-40 rounded-full -translate-y-8" style={{ backgroundColor: 'var(--secondary)' }}></div>
