...
const STEPS = [
  { id: 1, label: "Meme Details",          icon: Type },
          ...
          <div className="flex flex-col gap-5">
            ...
            <Field label="Post Description">
              <textarea
                ...
                placeholder="What is this meme about? Describe the message, joke, or trend you want to capture…"
                rows={3}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-2 flex-none">
                    <label
                      ...
                      style={{ background: formData.brandColor || formData.primaryColor || "#2563eb" }}
                    >
                      <input
                        type="color"
                        value={formData.brandColor || formData.primaryColor || "#2563eb"}
          ...
          {step < 3 ? (
            ...
            >
              {generating
                ...
                : <><Sparkles className="w-4 h-4" /> Generate Memes</>
              }
            </button>
          )}
        </div>
