      ...
      <div className="example-poster relative w-full max-w-md rounded-3xl shadow-2xl overflow-hidden" style={{
       background: 'var(--gradient-primary)',
        ...
        <div className="relative z-10 h-full flex flex-col p-8">
          ...
          {/* Main Headline */}
          <div className="mb-4">
            <h1 className="text-4xl font-bold leading-tight tracking-tight mb-1" style={{ color: 'var(--secondary)' }}>
              Market Value Made
            </h1>
            <div className="inline-block px-4 py-1" style={{ backgroundColor: 'var(--secondary)' }}>
              <h1 className="text-4xl font-black leading-tight tracking-tight" style={{ color: 'var(--primary)' }}>
                Easy to Learn
              </h1>
            </div>
          </div>
