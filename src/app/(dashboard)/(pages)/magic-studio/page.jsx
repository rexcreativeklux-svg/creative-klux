...
import { ArrowLeft, AudioLines, ChevronRight, FileImage, Layers, Mic, Sparkles, User, Video } from "lucide-react";
                ...
                {creative.categories.map((cat) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                {Icon && (
                                    <Icon size={14} strokeWidth={2} color={active ? "white" : creative.color} />
                                )}
                            </div>
...
export default function MagicStudioPage() {
    ...
    const renderForm = () => {
        ...
        switch (selectedCategory) {
            case "text_to_image": return <TextToImageForm       {...commonProps} />;
            case "text_to_video": return <TextToVideoForm       {...commonProps} />;
            case "image_to_variations": return <ImageToVariationsForm {...commonProps} />;
            case "script_to_voiceover": return <ScriptToVoiceoverForm {...commonProps} />;
            case "audio_to_text": return <AudioToTextForm       {...commonProps} />;
            case "persona_generator": return <PersonaBasedGeneratorForm {...commonProps} />;
            case "text_to_audio": return <TextToAudioForm       {...commonProps} />;
            default: return <ComingSoon category={category} />;
        }
    };
