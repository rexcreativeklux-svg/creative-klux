  ...
  return (
    <div className=" flex items-center justify-center p-8">
      ...
      >
        ...
        {/* bottom right */}
        <div
          className="absolute -bottom-40 rotate-30 -right-0 "
          style={{
            fontSize: "550px",
            lineHeight: "0.8",
            fontWeight: "600",
        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          <div className="mb-4 ">
            <h1 className="text-3xl flex text-[var(--primary)] gap-1 justify-center font-black ">
              Your Market Are{" "}
              <span className="text-[var(--secondary)] mt-1 text-[35px]">
                *
              </span>
            </h1>
            ...
            <div className="relative flex items-center justify-between">
              ...
              <div className="absolute top-0 left-0">
                <p className="text-xs font-bold text-gray-600 mb-1">
                  From{" "}
                  <span className="text-lg font-black text-gray-900">2020</span>
                </p>
              </div>

              {/* To 2025 */}
              <div className="absolute bottom-0 right-0">
                <p className="text-xs font-bold text-gray-600 text-right mb-1">
                  To{" "}
                  <span className="text-lg font-black text-gray-900">2025</span>
                </p>
              </div>
          ...
          <div className="rounded-full flex justify-center items-center relative top-8 bg-[var(--secondary)] pt-6 pb-14 shadow-lg">
            <div className="flex items-center gap-10 justify-between">
              <div className="flex flex-row gap-6">
                <h3 className="text-md text-[var(--primary)] font-bold flex items-center leading-tight ">
                  Market <br /> Values
                </h3>
              ...
              <button className="shrink-0 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-lg hover:scale-105 transition-transform">
