    ...
    <div className="min-h-screen flex items-center justify-center p-8 ">
      ...
      >
        <div className="relative z-10 h-full flex flex-col">
          {/* Top green section */}
          <div className=" p-8 pb-50 bg-[image:var(--linear-secondary)] flex flex-col">
            ...
            <div className="flex items-start justify-between mb-14">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="text-left">
                  <div className="text-xs font-bold text-[var(--secondary)]">
                    YOUR
                  </div>
                  <div className="text-xs font-bold text-[var(--secondary)]">
                    LOGO
            ...
            <div className="flex-1 flex flex-col w-[230px] relative -mb-5 justify-center">
              ...
              <p className="text-sm font-medium text-[var(--secondary)] w-[180px] opacity-90">
                From small startups to global clients—results that speak louder
                than slides.
              </p>
            </div>
          </div>
