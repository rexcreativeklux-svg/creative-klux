...
const AdsCreativesPage = () => {
  ...
  const creativeOptions = [
    ...
    },
    {
      ...
      bg: "bg-linear-to-br from-gray-900 via-gray-700 to-gray-500 group-hover:from-gray-600 group-hover:via-gray-600 group-hover:to-gray-600",
      content: (
        <>
          <div className="absolute inset-0 bg-linear-to-tr from-white/10 to-transparent opacity-60 group-hover:animate-none"></div>
          <div
            className="absolute top-4 left-4 w-8 h-6 bg-surface/20 rounded opacity-70 group-hover:animate-pulse"
            style={{ animationDelay: "0s" }}
          ></div>
          <div
            className="absolute top-8 right-8 w-6 h-4 bg-surface/15 rounded opacity-50 group-hover:animate-pulse"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute bottom-6 left-8 w-10 h-3 bg-surface/25 rounded opacity-60 group-hover:animate-pulse"
          ...
          <div className="relative z-10 flex items-center justify-center">
            <div className="relative">
              ...
              <div
                className="absolute inset-0 w-20 h-20 bg-surface/10 rounded-full group-hover:animate-pulse"
              ...
              <div className="relative w-20 h-20 bg-surface/90 rounded-full flex items-center justify-center group-hover:bg-surface transition-colors duration-300 shadow-lg">
                <Play
                  className="w-8 h-8 text-gray-600 fill-current ml-1"
                  strokeWidth={0}
                />
              </div>
            </div>
          ...
          <div className="absolute top-3 left-3 flex space-x-1">
            <div
              className="w-2 h-2 bg-slate-500/60 rounded-full group-hover:animate-bounce"
              style={{ animationDelay: "0s" }}
            ></div>
            <div
              className="w-2 h-2 bg-slate-500/60 rounded-full group-hover:animate-bounce"
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div
              className="absolute top-1/4 left-1/4 w-1 h-1 bg-slate-400/60 rounded-full group-hover:animate-ping"
              style={{ animationDelay: "1s" }}
            ></div>
            <div
              className="absolute top-3/4 right-1/4 w-1 h-1 bg-slate-500/40 rounded-full group-hover:animate-ping"
              style={{ animationDelay: "2s" }}
            ></div>
            <div
              className="absolute top-1/2 left-3/4 w-1 h-1 bg-slate-400/50 rounded-full group-hover:animate-ping"
    ...
    },
    {
      ...
      bg: "bg-linear-to-br from-emerald-50 to-teal-100 group-hover:from-emerald-100 group-hover:to-teal-200",
      content: (
        <>
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-32 h-32 border-2 border-emerald-200 rounded-full opacity-30 group-hover:animate-ping"></div>
            <div
              className="absolute w-24 h-24 border-2 border-teal-300 rounded-full opacity-50 group-hover:animate-ping"
              style={{ animationDelay: "0.3s" }}
            ></div>
            <div
              className="absolute w-16 h-16 border-2 border-emerald-400 rounded-full opacity-70 group-hover:animate-ping"
          ...
          <div className="relative z-10 flex items-center justify-center">
            <div className="relative">
              <Boxes
                className="w-14 h-14 text-emerald-600 group-hover:text-emerald-700 transition-colors"
                strokeWidth={1.5}
              />
          ...
          <div className="absolute top-12 left-12 w-8 h-1 bg-linear-to-r from-emerald-300 to-transparent rounded opacity-30 group-hover:opacity-50 group-hover:animate-pulse transition-opacity transform rotate-45"></div>
          <div className="absolute bottom-12 right-12 w-6 h-1 bg-linear-to-r from-teal-300 to-transparent rounded opacity-40 group-hover:opacity-60 group-hover:animate-pulse transition-opacity transform -rotate-45"></div>
        </>
      ),
    },
    {
      ...
      bg: "bg-linear-to-br from-gray-200 to-slate-200 group-hover:from-slate-100 group-hover:to-gray-200",
      content: (
        <>
          ...
          <div className="relative z-10 flex items-center justify-center space-x-4">
            <div className="relative">
              <Film
                className="w-16 h-16 text-slate-600 group-hover:text-slate-700 transition-colors"
                strokeWidth={1.5}
              />
            ...
            <div className="flex flex-col space-y-2">
              <div
                className="w-3 h-3 bg-slate-400 rounded-full group-hover:bg-slate-500 transition-colors animate-ping"
                style={{ animationDelay: "2s" }}
              ></div>
              <div
                className="w-3 h-3 bg-slate-300 rounded-full group-hover:bg-slate-400 transition-colors animate-ping"
    ...
    <div className="px-0 lg:px-14 h-full">
      ...
      <div className="flex flex-col items-center justify-center text-center py-5">
        ...
        <p className="text-gray-500 text-lg mb-4">
          No ads creative have been created yet. <br /> Click the create button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-start">
              {creativeOptions.map((opt) => (
                ...
                >
                  ...
                  <div className="mb-0">
                    <div
                      className={`w-full h-40 ${opt.bg} rounded-xl flex items-center justify-center mb-6 transition-all duration-300 relative overflow-hidden border border-gray-200/50`}
                    >
                      {opt.content}
                    </div>
                  </div>
