                    ...
                    <div className=" mt-5 lg:w-[500px] ">
                        <form onSubmit={handleSubmit} className="space-y-6 relative w-full">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className={`w-full py-3 cursor-pointer rounded-xl transition-all duration-300 font-semibold flex items-center justify-center gap-3
        ${loading
                                        ? 'bg-gray-400 text-gray-200 cursor-not-allowed'
                                        : 'bg-black text-white hover:bg-gray-800 hover:scale-[0.98] active:scale-95'
                                    }`}
                            >
                                {loading ? (
                                    <>
                    ...
                    <div className="mt-10 sm:mt-20 flex justify-center text-center">
                        ...
                        <Link href="/register" className="text-[#155dfc] px-1 font-semibold hover:underline">
                            Register
                        </Link>
                    </div>
                </div>
            ...
            {toast.show && (
                <Toast
                    ...
                    isOpen={toast.show}
                    onClose={closeToast}
                    duration={2000}   // matches your navigation delay
                />
            )}
        </div>
