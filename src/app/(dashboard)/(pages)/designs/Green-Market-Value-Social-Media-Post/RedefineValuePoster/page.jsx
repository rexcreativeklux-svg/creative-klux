                ...
                <div className="relative z-10 h-full justify-between flex flex-col p-8">
                    ...
                    <div className="flex absolute top-16 rotate-[-4deg] left-40 z-20 justify-center mb-6">
                        <div className="bg-white px-4 py-1 text-[var(--tertiary)] rounded-full shadow-lg" >
                            <span className="text-sm font-bold text-gray-600">Market Value</span>
                        </div>
                    </div>

                    {/* Large yellow card */}
                    <div className="relative mt-12 rounded-lg h-[380px] shadow-2xl overflow-hidden" style={{ backgroundColor: 'var(--secondary)' }}>
                        ...
                        <div className="absolute bottom-0 right-0 w-full h-full overflow-hidden pointer-events-none opacity-20">
                            <svg className="absolute bottom-0 right-0 w-[120%] h-[80%]" viewBox="0 0 400 300" preserveAspectRatio="none">
                                <path
                        ...
                        <div className="relative z-10 p-8 h-full flex flex-col  text-center">
                            {/* Main headline */}
                            <div className="mb-8">
                                <h1 className="text-5xl font-black  tracking-tight" style={{ color: 'var(--text-on-secondary)' }}>
                                    READY TO<br />
                                    <span className="inline-block px-4 py-1 my-1" style={{ backgroundColor: 'var(--text-on-secondary)', color: 'var(--secondary)' }}>
                                        REDEFINE
                                    </span><br />
                                    YOUR VALUE
                                </h1>
                            ...
                            <div className=" flex items-center">
                                <p className="text-sm font-medium" style={{ color: 'var(--text-on-secondary)' }}>
