...
import {
  ...
  X, Loader2, MoreHorizontal, Maximize2, Share2, CheckCircle2,
} from "lucide-react";
...
const FAKE_RESULT = {
  summary: [
    { label: "Platform", status: "FAILED" },
    { label: "Brand", status: "WARNING" },
    { label: "Legal", status: "FAILED" },
  ],
  sections: [
    {
      ...
      items: [
        {
          name: "Meta / Instagram",
          status: "FAILED",
          desc: "Excessive text overlay — likely violates the 20% text-to-image rule. Reduce headline size or use a dedicated text zone.",
        },
        {
          name: "Google Ads",
          status: "WARNING",
          desc: 'May contain language flagged by Google\'s sensitive categories policy. Review for absolute claims ("best", "guaranteed").',
        },
        {
          name: "LinkedIn",
          status: "PASSED",
          desc: "Professional tone, clear messaging — aligned with LinkedIn business advertising standards.",
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "Brand Tone Mismatch",
          status: "WARNING",
          desc: "Ad copy uses casual language inconsistent with your brand's defined professional tone. Consider revising.",
        },
        {
          name: "Logo Placement",
          status: "WARNING",
          desc: "Logo is partially obscured. Adjust to ensure full visibility within safe zones.",
        },
        {
          name: "Color Scheme",
          status: "WARNING",
          desc: "Background color deviates from your approved brand palette. Use brand-approved colors.",
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "Image Rights",
          status: "FAILED",
          desc: "Image usage cannot be verified. Ensure all imagery is licensed, royalty-free, or original.",
        },
        {
          name: "Legal Disclaimer",
          status: "WARNING",
          desc: "Required disclaimer may be missing for your target region. Add required legal copy below the CTA.",
        },
        {
          name: "Copyright Check",
          status: "PASSED",
          desc: "No copyrighted text, logos, or media detected in the creative assets.",
        },
      ],
    },
  ],
            ...
            >
              <div className="w-full max-w-xl bg-white rounded-2xl border border-gray-200 p-6 flex flex-col gap-5">
                  ...
                  {file && preview ? (
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 w-7 h-7 bg-white rounded-full border border-gray-200 flex items-center justify-cen2er  hover:bg-gray-200 hover:scale-105 cursor-pointer transition"
                      >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3.5 hover:scale-105 rounded-lg text-sm font-semibold text-white transition-all cursor-pointer disabled:opacity-50"
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="bg-white rounded-2xl border border-gray-200  p-4">
                      ...
                      return (
                        <label key={p.id} className="flex items-center gap-2.5 cursor-pointer">
                          <div
                            onClick={() => togglePlatform(p.id)}
                            className="w-4 h-4 rounded flex items-center justify-center border transition-all duration-150 cursor-pointer"
                            style={{ background: checked ? PRIMARY : "white", borderColor: checked ? PRIMARY : "#d1d5db" }}
                          >
                            {checked && (
                              <svg className="w-2.5 h-2.5" fill="none" stroke="white" strokeWidth="3" viewBox="0 0 24 24">
                                <path d="M5 13l4 4L19 7" strokeLinecap="round" strokeLinejoin="round" />
                          ...
                          <span className="text-sm" style={{ color: checked ? "#111827" : "#6b7280" }} onClick={() => togglePlatform(p.id)}>
                            {p.label}
                          </span>
                        </label>
                      );
                  ...
                  <button
                    ...
                    className="mt-3 w-full hover:scale-95 flex items-center justify-center gap-2 py-2.5 rounded-lg text-xs font-semibold text-white transition cursor-pointer disabled:opacity-50"
                    style={{ background: `linear-gradient(135deg, ${PRIMARY}, #1d4ed8)` }}
                  >
                    {checking
