...
const Header = ({ isPanelOpen, togglePanel, closePanel, openPanel, setShowModal }) => {
  ...
  return (
    <div className={`flex fixed top-0  w-full items-center justify-between border-custom bg-white px-4 sm:px-10 lg:px-8 py-4 z-50  ${isPanelOpen ? "left-[330px] w-[calc(100%-250px)]" : "left-20  right-0"}`}>
      <div className="flex items-center space-x-4">
        ...
        >
          {isPanelOpen ? (
            <ChevronLeft className="h-8 w-8 text-[#155dfc]" />
          ) : (
            <AlignLeft className="h-8 w-8 text-[#155dfc]" />
          )}
        </button>
