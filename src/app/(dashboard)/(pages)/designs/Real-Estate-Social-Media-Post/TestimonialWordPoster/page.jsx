...
export default function TestimonialWordPoster() {
  return (
    <div className="flex items-center justify-center">
      <div
        className="Real-Estate-Social-Media-Post relative w-full max-w-md rounded-3xl shadow-2xl overflow-hidden"
        style={{
        ...
        <div className="relative z-10 h-full flex flex-col p-8">
          ...
          <div className="flex items-start mb-6">
            <div className="flex items-center gap-2">
              ...
              <div className="text-left">
                <div className="text-sm font-bold text-[var(--secondary)] tracking-wide">
                  REAL ESTATE
                </div>
          ...
          <div className="text-center px-7 mb-6">
            <p className="text-sm text-[var(--secondary)] ">
              Hear directly from the homeowners we've had the honor of guiding
              on their journey.
            </p>
          </div>
          ...
          <div className="flex flex-col relative space-y-6">
            ...
            <div className="bg-[var(--secondary)] relative left-19  w-[300px] rotate-[-3deg] rounded-2xl px-3 py-2 shadow-lg flex gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] text-medium text-[var(--primary)]">
                  We were so nervous about the whole process. We feel so calm
                  and confident now.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[var(--secondary)] relative left-19 w-[300px] rotate-[-3deg] rounded-2xl p-3 shadow-lg flex gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] text-medium text-[var(--primary)]">
                  I knew I wanted to sell but didn't know where to start. They
