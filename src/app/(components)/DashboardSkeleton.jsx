...
export default function DashboardSkeleton() {
  return (
    ...
    >
      ...
      <nav
        className="hidden md:flex flex-col justify-between h-screen bg-surface border-r border-gray-100 shrink-0"
        style={{ width: 188 }}
      >
        {/* Logo */}
        <div>
          ...
          {["Brand Kits", "Creative Studio", "Product Studio"].map((_, i) => (
            <div
              key={i}
              className="mx-3 mb-0.5 flex items-center gap-2.5 px-3 py-2 rounded-lg"
            >
        ...
        <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-7 gap-3">
            {Array.from({ length: 7 }).map((_, i) => (
              <div
                key={i}
                className="bg-surface border border-gray-100 rounded-xl p-4 flex flex-col gap-2"
              >
                <Pulse w={28} h={28} rounded="8px" />
          ...
          >
            ...
            <div className="bg-surface border border-gray-100 rounded-xl p-5 flex flex-col gap-4">
              ...
              <Pulse
                ...
                h={48}
                rounded="12px"
                style={{ background: "#e5c5f5", marginTop: "auto" }}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-4">
              {Array.from({ length: 4 }).map((_, i) => (
                <div
                  key={i}
                  className="rounded-xl overflow-hidden border border-gray-100 bg-surface"
                >
