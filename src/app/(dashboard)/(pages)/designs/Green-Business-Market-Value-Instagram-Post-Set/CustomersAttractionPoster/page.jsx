            ...
            >
                ...
                <div className="relative z-10 h-full flex flex-col p-8">
                        ...
                        <div className="flex-1 flex flex-col">
                            ...
                            <div className="flex items-center relative -right-18 gap-2 mb-4">
                                ...
                                <div className="text-left">
                                    <div className="text-xs font-bold text-[var(--primary)]">Company</div>
                            ...
                            <div className='relative -left-5'>
                                ...
                                <div className="inline-flex relative w-[600px] items-center gap-2 px-4 bg-[var(--secondary)]" >
                                    ...
                                    <span className="text-4xl relative pl-6 font-bold text-white">Today?</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 rounded-3xl px-5 py-6 shadow-2xl bg-[var(--primary)] relative">
                        ...
                        <div className="ml-12 relative z-10">
                            <h2 className="text-lg font-bold border-b-2 pb-3 text-[var(--secondary-light)] mb-4">
                                Want loyal, aligned customers?<br />
                            ...
                            <ul className="space-y-2">
                                <li className="flex items-start gap-3 text-[var(--secondary-light)]">
                                    <span className="flex-shrink-0 w-1.5 h-1.5 rounded-full mt-2 bg-[var(--secondary-light)]"></span>
                                    <span className="text-sm leading-relaxed">Strong values filter in audiences.</span>
                                </li>
                                <li className="flex items-start gap-3 text-[var(--secondary-light)]">
                                    <span className="flex-shrink-0 w-1.5 h-1.5 rounded-full mt-2 bg-[var(--secondary-light)]"></span>
                                    <span className="text-sm leading-relaxed">People support brands they feel emotionally connected.</span>
                                </li>
                                <li className="flex items-start gap-3 text-[var(--secondary-light)]">
                                    <span className="flex-shrink-0 w-1.5 h-1.5 rounded-full mt-2 bg-[var(--secondary-light)]"></span>
                                    <span className="text-sm leading-relaxed">Communicating your values.</span>
                                </li>
                                <li className="flex items-start gap-3 text-[var(--secondary-light)]">
                                    <span className="flex-shrink-0 w-1.5 h-1.5 rounded-full mt-2 bg-[var(--secondary-light)]"></span>
                                    <span className="text-sm leading-relaxed">Aligned with customers.</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="mt-5 flex items-center justify-between">
                        <span className="text-sm font-bold text-[var(--primary)]">@yoursocialmedia</span>
