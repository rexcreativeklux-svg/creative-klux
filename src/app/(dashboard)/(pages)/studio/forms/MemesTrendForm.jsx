...
const MemesTrendForm = ({ formData, setFormData, activeBrand, sendUrl, showToast, onResult }) => {
                    ...
                    {STEPS.map((s, idx) => {
                        ...
                        return (
                            <React.Fragment key={s.id}>
                                ...
                                >
                                    <div className={`shrink-0 w-8 h-8 rounded-full border-2 flex items-center justify-center transition-all ${step > s.id ? "border-emerald-600 bg-emerald-600 text-white"
            ...
            <div className="bg-white px-2 rounded-lg py-2 flex flex-col gap-6">
                ...
                {step === 1 && (
                    <div className="flex flex-col gap-5">
                        <SectionTitle>Meme Details</SectionTitle>
                            ...
                            <div className="flex flex-wrap gap-2 py-1">
                                {TONES.map((t) => (
                                    <button
                                        ...
                                        className={`px-3 py-1.5 rounded-md border cursor-pointer text-xs font-semibold transition-all ${formData.tone === t.value
                                ...
                                {PLATFORMS.map((p) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`px-3 py-1.5 rounded-md border cursor-pointer text-xs font-semibold transition-all ${active
                                                    ? "border-emerald-600 bg-emerald-50 text-emerald-700"
                                                    : "border-gray-100 bg-gray-50 text-gray-500 hover:border-gray-300"
                                                }`}
                                        >
                                    ...
                                    <div className="flex items-center gap-1.5 flex-wrap max-w-44">
                                        {BRAND_COLORS.map((hex) => (
                                            <button
                                                ...
                                                className={`w-7 h-7 rounded-md cursor-pointer border-2 transition-transform hover:scale-110 ${formData.primaryColor === hex ? "border-gray-800 scale-110" : "border-transparent"
                                                    }`}
                            ...
                            <div className="grid grid-cols-4 gap-2">
                                {SIZE_OPTIONS.map((s) => (
                                    <button
                                        ...
                                        className={`text-left px-2 py-2 cursor-pointer rounded-lg border-2 transition-all ${formData.size === s.value
                                                ? "border-emerald-600 bg-emerald-50 text-emerald-700"
                            ...
                            <div className="flex flex-wrap gap-2">
                                {CAMPAIGN_GOALS.map((g) => (
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-lg cursor-pointer text-xs font-medium border-2 transition-all ${formData.campaignGoal === g
                                                ? "border-emerald-600 bg-emerald-50 text-emerald-700"
                                                : "border-gray-100 bg-gray-50 text-gray-600 hover:border-gray-300"
                                            }`}
                                    >
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                {AUDIENCES.map((a) => (
                                    <button
                                        ...
                                        className={`text-left px-2 py-2 cursor-pointer rounded-lg border-2 transition-all ${formData.audience === a.value ? "border-emerald-600 bg-emerald-50" : "border-gray-100 bg-gray-50 hover:border-gray-300"
                                            }`}
                                    >
                            ...
                            <div className="flex gap-2">
                                {FILE_FORMATS.map((f) => (
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-lg cursor-pointer text-xs font-medium border-2 transition-all ${formData.fileFormat === f
                                                ? "border-emerald-600 bg-emerald-50 text-emerald-700"
                                                : "border-gray-100 bg-gray-50 text-gray-600 hover:border-gray-300"
                                            }`}
                                    >
