...
const T = {
  ...
  stepCurrent:  "border-purple-600 text-purple-600 bg-white",
      ...
      <div className="bg-white rounded-lg p-2 flex flex-col gap-5">
            ...
            <Field label="Flyer Description" required>
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute bottom-3 left-3 text-xs font-semibold bg-white border border-gray-200 text-gray-500 hover:border-purple-400 hover:text-purple-600 px-3 py-1 rounded-lg cursor-pointer transition-all flex items-center gap-1.5"
                >
                  ✨ Inspire Me
                </button>
        ...
        {step === 3 && (
          <div className="flex flex-col gap-4">
            ...
            >
              <div className="w-10 h-10 bg-white border border-purple-200 rounded-xl flex items-center justify-center shadow-sm">
