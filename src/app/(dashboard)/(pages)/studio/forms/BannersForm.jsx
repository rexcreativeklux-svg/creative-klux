...
import {
  ...
  Sparkles, Images, Scan, LayoutTemplate,
} from "lucide-react";
...
const SIZE_OPTIONS = [
  ...
  { value: "2560x1440", label: "YouTube Channel Art",      group: "Social Covers" },
   { value: "1080x1080", label: "1:1 — Square", group: "Social Covers" },
  // Banners
...
const CAMPAIGN_GOALS = [
  "Brand Awareness", "Engagement", "Sales", "Lead Generation", "Website Traffic", "Event Registration",
];
...
const CTA_OPTIONS = [
  "Learn More", "Shop Now", "Get Started", "Register Free",
  "Download Now", "Book a Demo", "View Offer",
];
...
const BannersForm = ({
  ...
  // ── field helper ──────────────────────────────────────────────────────────
  // brandColor ↔ primaryColor kept in sync (mirrors ImageAdsForm pattern)
  const field = (key, value) => {
    if (key === "brandColor" || key === "primaryColor")
  ...
  const handleGenerate = async () => {
    ...
    const payload = {
      ...
      bannerType:   formData.bannerType   || null,
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center gap-2 flex-none">
                    <label
                      ...
                      style={{ background: formData.brandColor || "#7c3aed" }}
                    >
                      <input
                        type="color"
                        value={formData.brandColor || "#7c3aed"}
                    ...
                    {sizes.map((s) => (
                      ...
                      >
                        ...
                        <p className={`text-[10px] mt-0.5 font-mono ${
                          formData.size === s.value && formData.sizeLabel === s.label ? "text-emerald-500" : "text-gray-400"
                        }`}>{s.value}</p>
                      </button>
                    ))}
                  </div>
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-400 mt-1">
                  {formData.size ? `Optimal size: ${formData.size}px` : "Choose a size in Step 2 for best results"}
                </p>
              </div>
              <button
