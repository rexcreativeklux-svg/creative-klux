...
//                 >
//                     <Icon className="w-4 h-4" style={{ color: accent ? '#003dda' : '#6b7280' }} />
//                 </div>
//             </div>
...
//         const dayPosts = publishedPosts.filter(p => p.published_at && isSameDay(new Date(p.published_at), day));
//         return {
//             date: label,
...
//                 <div>
//                     <h1 className="text-2xl font-bold text-gray-900 mb-1">Ads Analytics</h1>
//                     <p className="text-gray-500 text-sm">Aggregated ads performance across platforms</p>
//                 </div>
...
//                         <StatCard icon={CheckCircle2} label="Published Ads"     value={publishedPosts.length} accent />
...
//                             No stats fetched yet. Click <strong className="mx-1">Refresh Stats</strong> to pull live metrics from connected Facebook / Instagram accounts.
//                         </div>
//                     )}
...
//                                         <th className="text-left px-4 py-2.5 text-xs text-gray-400 font-semibold">Ad</th>
//                                         <th className="text-left px-3 py-2.5 text-xs text-gray-400 font-semibold">Platform</th>
//                                         <th className="text-center px-3 py-2.5 text-xs text-gray-400 font-semibold">Impressions</th>
//                                         <th className="text-center px-3 py-2.5 text-xs text-gray-400 font-semibold">Reach</th>
//                                         <th className="text-center px-3 py-2.5 text-xs text-gray-400 font-semibold">Clicks</th>
//                                         <th className="text-center px-3 py-2.5 text-xs text-gray-400 font-semibold">Likes</th>
//                                         <th className="text-center px-3 py-2.5 text-xs text-gray-400 font-semibold">CTR</th>
//                                         <th className="text-right px-4 py-2.5 text-xs text-gray-400 font-semibold">Updated</th>
//                                     </tr>
//                                 </thead>
//                                 <tbody>
...
//                                                         )}
//                                                         <p className="text-xs text-gray-800 truncate max-w-[160px]">{post.project_title}</p>
//                                                     </div>
//                                                 </td>
    ...
    return (
        <div>
            ...
            {publishedPosts.length === 0 ? (
                <div className="rounded-xl border-2 border-dashed border-gray-200 bg-white p-16 text-center">
                    <BarChart3 className="w-10 h-10 text-gray-300 mx-auto mb-3" />
                    <p className="text-gray-800 font-semibold mb-1">No published posts yet</p>
                    <p className="text-gray-400 text-sm">Publish content from Creatives to start seeing analytics.</p>
                </div>
            ) : (
                <div className="space-y-6">
                    ...
                    <div className="rounded-xl bg-white border border-gray-200 overflow-hidden shadow-sm">
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-sm">
                                <thead>
                                    <tr className="border-b border-gray-100 bg-gray-50">
                                        <th className="text-left px-4 py-2.5 text-xs text-gray-400 font-semibold">Post</th>
                                        <th className="text-left px-3 py-2.5 text-xs text-gray-400 font-semibold">Platform</th>
                                        <th className="text-center px-3 py-2.5 text-xs text-gray-400 font-semibold">Impressions</th>
                                        <th className="text-center px-3 py-2.5 text-xs text-gray-400 font-semibold">Reach</th>
                                        <th className="text-center px-3 py-2.5 text-xs text-gray-400 font-semibold">Clicks</th>
