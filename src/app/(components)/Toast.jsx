...
export default function Toast({
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <div
            className={`rounded-xl shadow-2xl border px-6 py-4 flex items-center gap-3 min-w-[320px] max-w-md
  ${isError ? "bg-red-50 border-red-200" : "bg-surface border-gray-100"}`}
          >
            ...
            {/* Message */}
            <p className="text-gray-600 text-xs font-medium flex-1 pr-4">
              {message}
            </p>
