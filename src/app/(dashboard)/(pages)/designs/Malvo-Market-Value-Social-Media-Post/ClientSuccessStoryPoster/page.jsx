...
export default function ClientSuccessStoryPoster() {
  return (
    <div className=" flex items-center justify-center">
      <div
        className="Malvo-Market-Value-Social-Media-Post relative w-full max-w-md rounded-3xl shadow-2xl overflow-hidden"
        style={{
      ...
      >
        ...
        {/* center */}
        <div
          className="absolute top-48 -right-3 "
          style={{
            fontSize: "450px",
            lineHeight: "0.8",
            fontWeight: "900",
        ...
        <div className="relative z-10 h-full flex flex-col p-8">
          ...
          <div className="flex items-center justify-between mb-5">
            ...
            <span className="text-[var(--text-on-secondary)] font-medium text-xs">
              @yourbrand
            </span>
          </div>
          ...
          <div className="mb-4">
            <h1 className="text-5xl font-bold">
              ...
              <br />
              <span
                className="inline-block px-3 py-1 rotate-[-3deg] rounded-lg text-[var(--tertiary)]"
                style={{ backgroundColor: "var(--secondary)" }}
              >
                Success
              </span>{" "}
          ...
          <div className="flex-1  flex justify-between mb-5">
            ...
            <div className=" flex max-w-[190px] relative bottom-3 flex-col justify-center">
              <p className="text-sm font-medium  mb-4">
                "Before working with Businest, we struggled to prove our real
                value in the market.
              </p>
              <p className="text-sm font-medium ">
                Their strategy not only increased our valuation but also
                attracted new investors."
              </p>
            </div>

            {/* Right side - Person image with orange background shape */}
            <div className="shrink-0 relative top-17">
          ...
          <div className="flex items-center relative bottom- justify-between">
            <button
              className="px-3 py-1 rounded font-bold text-sm shadow-lg text-[var(--tertiary)] hover:opacity-90 transition-opacity"
              style={{ backgroundColor: "var(--secondary)" }}
            >
              Contact Us!
            </button>
