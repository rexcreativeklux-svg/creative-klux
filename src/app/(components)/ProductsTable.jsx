  ...
  return (
    <div className="py-6 z-50">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="sm:text-xl flex px-5 font-semibold text-gray-900">
          Products Table
        </h1>
            ...
            >
              <div className="flex justify-between items-center pb-2 gap-3">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div
                    className={`w-12 h-12 rounded-lg bg-linear-to-br ${item.gradient} flex items-center justify-center text-white font-semibold text-sm`}
                  >
                    {item.platform}
                  </div>
                  <div>
