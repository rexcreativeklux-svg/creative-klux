...
export default function MarketValuePricePoster() {
  return (
    <div className=" flex items-center justify-center ">
      <div
        className="market-poster relative w-full max-w-md rounded-3xl shadow-2xl overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="relative z-10 h-full flex items-center justify-center p-8">
          <div className="flex flex-row gap-2 w-full h-[350px]">
            {/* Top card - Image */}
            <div className="bg-linear-to-br from-gray-200 to-gray-300 w-[50%] rounded-xl overflow-hidden shadow-xl">
              <img
            ...
            <div className="w-[50%] flex flex-col gap-2 rounded-xl shadow-xl">
              ...
              >
                <p
                  ...
                  style={{ color: "var(--text-on-primary)" }}
                >
                  A Combination Of Public Perception, Economic Trends, Brand
                  Strength, Regulations, And Psychological Factors That Shape
                  Its Value.
                </p>

                {/* Bottom text */}
                <p
                  className="text-[11px] leading-relaxed pb-9 font-medium"
                  style={{ color: "var(--text-on-primary)" }}
                >
                  Understanding Market Value Means Understanding The Story
                  Behind The Numbers.
                </p>
              </div>
            </div>
