...
const TextToAudioTab = () => {
  ...
  const styleOptions = [
    {
      ...
      label: "Classical",
      image:
        "https://images.pexels.com/photos/1693095/pexels-photo-1693095.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
    },
    {
      value: "Electronic",
      label: "Electronic",
      image:
        "https://images.pexels.com/photos/4614165/pexels-photo-4614165.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
    },
    {
      value: "Jazz",
      label: "Jazz",
      image:
        "https://images.pexels.com/photos/1540406/pexels-photo-1540406.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
    },
    {
      value: "Pop",
      label: "Pop",
      image:
        "https://images.pexels.com/photos/1105666/pexels-photo-1105666.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
    },
    {
      value: "Ambient",
      label: "Ambient",
      image:
        "https://images.pexels.com/photos/374710/pexels-photo-374710.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
    },
  ];
  ...
  const handleGenerateAudio = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://freesound.org/apiv2/search/text/?query=${encodeURIComponent(query)}&token=YOUR_FREESOUND_API_TOKEN&fields=id,name,previews,duration&page_size=6`,
      );
      ...
      const fallbackAudios = [
        {
          ...
          alt: `${inputData.text} - Variation 1`,
          duration: 240,
        },
        {
          id: 2,
          ...
          alt: `${inputData.text} - Variation 2`,
          duration: 240,
        },
        {
          id: 3,
          ...
          alt: `${inputData.text} - Variation 3`,
          duration: 240,
        },
        {
          id: 4,
          ...
          alt: `${inputData.text} - Variation 4`,
          duration: 240,
        },
        {
          id: 5,
          ...
          alt: `${inputData.text} - Variation 5`,
          duration: 240,
        },
        {
          id: 6,
          ...
          alt: `${inputData.text} - Variation 6`,
          duration: 240,
        },
      ];
  ...
  const CustomAudioPlayer = ({ audio, index }) => {
    ...
    return (
      <div
        className={`relative bg-surface hover:scale-95 border ${isPlaying ? accentColor : "border-gray-200"} rounded-lg transition-all duration-300 overflow-hidden cursor-pointer hover:border-opacity-100 p-4 shadow`}
      >
        <audio
        ...
        <div className="flex justify-between items-center gap-3 mb-3">
          <button
            ...
            className={`w-12 h-12 cursor-pointer rounded-full flex items-center justify-center transition-all shadow-md ${
              isPlaying
                ? "bg-linear-to-br from-blue-700 to-purple-600 text-white scale-105"
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-xs text-gray-500">
                {formatTime(audioRefs.current[audioId]?.currentTime || 0)} /{" "}
                {formatTime(
                  audioRefs.current[audioId]?.duration || audio.duration,
                )}
              </span>
            </div>
          </div>
        ...
        >
          <div
            className={`h-full transition-all duration-100 ${isPlaying ? "bg-linear-to-r from-blue-500 to-purple-600" : "bg-blue-600"}`}
        ...
        <div className="mt-2">
          <p className="text-xs text-gray-500 font-medium">
            ...
            <span
              className={
                inputData.style ? `text-${accentColor.split("-")[1]}-600` : ""
              }
            >
          ...
          <div>
            <div className="flex flex-col pb-5 justify-center">
              ...
              <p className="text-gray-600 text-xs">
                Enter a text prompt or get inspired to generate your audio.
              </p>
            </div>
