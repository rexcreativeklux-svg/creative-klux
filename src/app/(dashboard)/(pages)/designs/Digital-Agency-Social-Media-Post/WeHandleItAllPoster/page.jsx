...
export default function WeHandleItAllPoster() {
    return (
        <div className=" flex items-center justify-center ">
            ...
            <div className="struggling-poster relative w-full max-w-md rounded-3xl shadow-2xl overflow-hidden" style={{
                ...
                <div className="absolute  inset-0 overflow-hidden pointer-events-none opacity-10">
                    <svg className="absolute top-60 -left-30 rotate-0 w--100 h-full" viewBox="0 0 400 600" fill='none'>
                        <path
                            d="
      M300 80
    ...
    "
                ...
                {/* Large background checkmark */}
                <div className="absolute  inset-0 overflow-hidden pointer-events-none opacity-10">
                    <svg className="absolute top-70 -left-25 rotate-0 w-100 h-120" viewBox="0 0 400 600" fill='none'>
                        <path
                            d="
      M300 80
      C200 40, 90 140, 110 250
                ...
                <div className="relative z-10 h-full flex flex-col p-8">
                    ...
                    <div className="text-center mb-4">
                        <p className="text-xs font-medium text-white leading-relaxed">
                            With our Social Media Digital Marketing, you'll get targeted strategies that bring real results.
                        </p>
                    </div>
                    ...
                    <div className="text-center mb-8">
                        <h1 className="text-2xl font-bold leading-tight text-white mb-2">
                            From content creation<br />
                            to ad optimization
                        </h1>
                        <div className="inline-block px-2 rotate-7 mt-[-5px] py-1 rounded-full" style={{ backgroundColor: 'var(--secondary)' }}>
                            <h1 className="text-xl font-bold leading-tight" style={{ color: 'var(--text-on-secondary)' }}>
                                we handle it all
                            </h1>
                        </div>
                    </div>
